...
from nv_utils import download_FNO_dataset

download_FNO_dataset("Darcy_241", outdir="/srv/fast1/n.lokshin/")

filename = "/srv/fast1/n.lokshin/Darcy_241/piececonst_r241_N1024_smooth1.hdf5"

output_filenames = [
    "/srv/fast1/n.lokshin/Darcy_241/train.hdf5",
    "/srv/fast1/n.lokshin/Darcy_241/validation.hdf5",
]
